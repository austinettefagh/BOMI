...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <rules>
        ...
        <active>false</active>
        <description>--DEPRECATED--Set the last evaluation status on the Covenant object when it gets updated on the Covenant Compliance object.</description>
    ...
    <rules>
        ...
        <description>--DEPRECATED--Update the next Covenant Compliance evaluation date based on the frequency and the last scheduled evaluation date.</description>
    ...
    <rules>
        ...
        <active>true</active>
        <description>--DEPRECATED--Update the Last Evaluation Date on the Covenant Object when a covenant is reviewed</description>
