...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <fieldUpdates>
        ...
        <description>--DEPRECATED-- Specifies the Government Contracts page layout.</description>
        <field>RecordTypeId</field>
        <lookupValue>Collateral_Mgmt_UCC</lookupValue>
    ...
    <fieldUpdates>
        ...
        <description>--DEPRECATED-- Specifies the Possessory Letter of Credit page layout.</description>
        <field>RecordTypeId</field>
        <lookupValue>Collateral_Mgmt_Financial_Instruments_Possessory</lookupValue>
        <lookupValueType>RecordType</lookupValueType>
    ...
    <fieldUpdates>
        ...
        <description>--DEPRECATED-- Specifies the Possessory Life Insurance page layout</description>
        <field>RecordTypeId</field>
        <lookupValue>Collateral_Mgmt_Financial_Instruments_Possessory</lookupValue>
        <lookupValueType>RecordType</lookupValueType>
    ...
    <fieldUpdates>
        ...
        <description>--DEPRECATED-- Specifies the Possessory Other page layout.</description>
        <field>RecordTypeId</field>
        <lookupValue>Collateral_Mgmt_Financial_Instruments_Possessory</lookupValue>
        <lookupValueType>RecordType</lookupValueType>
    ...
    <fieldUpdates>
        ...
        <description>--DEPRECATED-- Specifies the Possessory Savings/CD page layout.</description>
        <field>RecordTypeId</field>
        <lookupValue>Collateral_Mgmt_Financial_Instruments_Possessory</lookupValue>
        <lookupValueType>RecordType</lookupValueType>
    ...
    <fieldUpdates>
        ...
        <description>--DEPRECATED-- Specifies the Possessory Securities page layout.</description>
        <field>RecordTypeId</field>
        <lookupValue>Collateral_Mgmt_Financial_Instruments_Possessory</lookupValue>
        <lookupValueType>RecordType</lookupValueType>
    ...
    <fieldUpdates>
        ...
        <description>--DEPRECATED-- Specifies the Real Estate page layout.</description>
        <field>RecordTypeId</field>
        <lookupValue>Collateral_Mgmt_Real_Estate</lookupValue>
        <lookupValueType>RecordType</lookupValueType>
    ...
    <fieldUpdates>
        <fullName>LLC_BI__Set_Collateral_Group_Record_Type</fullName>
        <description>--DEPRECATED-- Set the Record Type field to Group when the collateral mgmt record’s collateral type equals a group.</description>
        <field>RecordTypeId</field>
        <lookupValue>Collateral_Mgmt_UCC</lookupValue>
        <lookupValueType>RecordType</lookupValueType>
        <name>Set Collateral Group Record Type</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>LookupValue</operation>
        <protected>false</protected>
        <reevaluateOnChange>false</reevaluateOnChange>
    ...
    <fieldUpdates>
        ...
        <description>--DEPRECATED-- Specifies the Titled Aircraft page layout.</description>
        <field>RecordTypeId</field>
        <lookupValue>Collateral_Mgmt_Titled</lookupValue>
        <lookupValueType>RecordType</lookupValueType>
    ...
    <fieldUpdates>
        ...
        <description>--DEPRECATED-- Specifies the Titled Boat page layout.</description>
        <field>RecordTypeId</field>
        <lookupValue>Collateral_Mgmt_Titled</lookupValue>
        <lookupValueType>RecordType</lookupValueType>
    ...
    <fieldUpdates>
        ...
        <description>--DEPRECATED-- Specifies the Titled Mobile Home page layout.</description>
        <field>RecordTypeId</field>
        <lookupValue>Collateral_Mgmt_Titled</lookupValue>
        <lookupValueType>RecordType</lookupValueType>
    ...
    <fieldUpdates>
        ...
        <description>--DEPRECATED-- Specifies the Motor Vehicle page layout.</description>
        <field>RecordTypeId</field>
        <lookupValue>Collateral_Mgmt_Titled</lookupValue>
        <lookupValueType>RecordType</lookupValueType>
    ...
    <fieldUpdates>
        ...
        <description>--DEPRECATED-- Specifies the Titled Trailer/Other page layout.</description>
        <field>RecordTypeId</field>
        <lookupValue>Collateral_Mgmt_Titled</lookupValue>
        <lookupValueType>RecordType</lookupValueType>
    ...
    <fieldUpdates>
        ...
        <description>--DEPRECATED-- Specifies the Titled Vessel page layout.</description>
        <field>RecordTypeId</field>
        <lookupValue>Collateral_Mgmt_Titled</lookupValue>
        <lookupValueType>RecordType</lookupValueType>
    ...
    <fieldUpdates>
        ...
        <description>--DEPRECATED-- Specifies the UCC page layout.</description>
        <field>RecordTypeId</field>
        <lookupValue>Collateral_Mgmt_UCC</lookupValue>
        <lookupValueType>RecordType</lookupValueType>
        <name>UCC</name>
