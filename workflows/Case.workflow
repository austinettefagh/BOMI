...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <alerts>
        <fullName>Alert_Adverse_Action_for_Consumer_Underwriters</fullName>
        <description>Alert Adverse Action for Consumer Underwriters</description>
        <protected>false</protected>
        <recipients>
            <recipient>lfindlay@bankofmissouri.com</recipient>
            <type>user</type>
    ...
    <fieldUpdates>
        ...
        <field>OwnerId</field>
        <lookupValue>Commercial_Underwriters</lookupValue>
        <lookupValueType>Queue</lookupValueType>
