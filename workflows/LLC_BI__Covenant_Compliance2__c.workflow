...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <fieldUpdates>
        ...
        <description>--DEPRECATED-- Update the last evaluation status on the Covenant2 object.</description>
        <field>LLC_BI__Last_Evaluation_Status__c</field>
        <formula>Text(LLC_BI__Status__c)</formula>
    ...
    <fieldUpdates>
        ...
        <description>--DEPRECATED--Historic Financial Indicator Value to the value of the Financial Indicator Value of the related Covenant2 record</description>
...
DATE(
    ...
    <fieldUpdates>
        <fullName>Status_to_Recalled</fullName>
        <field>CF_Approval_Status__c</field>
        <literalValue>Recalled</literalValue>
        <name>Status to Recalled</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
        <reevaluateOnChange>false</reevaluateOnChange>
    ...
    <fieldUpdates>
        <fullName>Update_Status3</fullName>
        <field>CF_Approval_Status__c</field>
    ...
    <rules>
        ...
        <active>false</active>
        <description>--DEPRECATED--Set the last evaluation status on the Covenant2 object when it gets updated on the Covenant Compliance2 object.</description>
    ...
    <rules>
        ...
        <active>false</active>
        <description>--Deprecated-- Update the next Covenant Compliance2 evaluation date based on the frequency and the last scheduled evaluation date.</description>
    ...
    <rules>
        ...
        <active>false</active>
        <description>--Deprecated-- Update the Last Evaluation Date on the Covenant2 Object when a covenant is reviewed</description>
    ...
    <rules>
        ...
        <active>false</active>
        <description>--DEPRECATED--This workflow rule updates the Due Date field on the Covenant record using the Due Date and Frequency fields on the covenant.</description>
        <formula>OR(         AND(         ISPICKVAL(PRIORVALUE(LLC_BI__Status__c),&quot;Pending&quot;),         OR(         ISPICKVAL(LLC_BI__Status__c, &quot;Compliant&quot;),         ISPICKVAL(LLC_BI__Status__c, &quot;Waived&quot;)         )         ),         AND(         ISPICKVAL(LLC_BI__Status__c, &apos;Exception&apos;),         ISPICKVAL(PRIORVALUE(LLC_BI__Status__c),&quot;Pending&quot;)         )         )</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        ...
        <description>--DEPRECATED--When Spreads automated testing evaluates a Covenant_Compliance2 record to have complete data or pass a Covenant rule, this sets the Status to Compliant.</description>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        ...
        <description>--DEPRECATED--When Spreads automated testing evaluates a Covenant_Compliance2 record to have incomplete data or fail a Covenant rule, this sets the Status to Exception and the Exception Date to today.</description>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        <fullName>LLC_BI__Set_Historic_Financial_Indicator_Value</fullName>
        ...
        <description>--DEPRECATED--When the Covenant_Compliance2 Status is set to Compliant, sets the Historic Financial Indicator Value to Covenant2.Financial_Indicator_Value</description>
