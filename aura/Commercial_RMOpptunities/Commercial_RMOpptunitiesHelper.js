({
    ...
    setData : function(component,query,whichOne) 
    {
        ...
        {
            filter = "LastActivityDate >= LAST_N_MONTHS:6 AND Amount > 50000000"
        }
        ...
        {
            filter = "Amount > 50000000 AND StageName = 'Onboarding'";
        }
        else if(whichOne==="ActivityValueStageButton")
        {
            filter = "LastActivityDate >= LAST_N_MONTHS:6 AND Amount > 50000000 AND StageName = 'Onboarding'";
        }
        ...
        {
            filter = "Amount > 50000000 AND "+query;
        }
        ...
        {
            filter = "LastActivityDate >= LAST_N_MONTHS:6 AND Amount > 50000000 AND "+query;
        }
        ...
        {
            filter = "Amount > 50000000 AND StageName = 'Onboarding' AND "+query;
        }
        else if(whichOne==="bothsectionfilters123Selected")
        {
            filter = "LastActivityDate >= LAST_N_MONTHS:6 AND Amount > 50000000 AND StageName = 'Onboarding' AND "+query;
        }
    ...
    sortData : function(component,fieldName,sortDirection)
    {
        ...
        if(fieldName == 'Amount' || fieldName == 'Probability'|| fieldName == 'Metric_C__c' ){ 
