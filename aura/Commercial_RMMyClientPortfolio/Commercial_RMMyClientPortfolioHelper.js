({
    setTable : function(component, event)
    {
        ...
        component.set('v.columns', [
            ...
            {label: 'TYPE',fieldName: 'CF_Type__c',type: 'text',sortable: true},
            ...
            {label: 'STATE', fieldName: 'BillingState',type: 'text',cellAttributes: { alignment: 'left', class: {fieldName: 'BillingState'} },
                sortable :true},
            // {label: 'LAST ACTIVITY', fieldName: 'LastActivityDate', type: '',
            //     cellAttributes: { alignment: 'left' },
            //     sortable :true},
            {label: 'ENTITY TYPE', fieldName: 'Type', type: 'text',
                cellAttributes: { alignment: 'left' },
                sortable :true},
	...
	getData : function(component,query,whichOne) 
    {
            ...
            {
            filter = "FinServ__TotalRevenue__c > 50000000";
            }
            ...
            {
            filter = "LastActivityDate >= LAST_N_MONTHS:6 AND FinServ__TotalRevenue__c > 50000000";
            }
            ...
            {
            filter = "FinServ__TotalRevenue__c > 50000000 AND FinServ__Status__c = 'Active'";
            }
            else if(whichOne==="ActivityValuestatusButton")
            {
            filter = "LastActivityDate >= LAST_N_MONTHS:6 AND FinServ__TotalRevenue__c > 50000000 AND FinServ__Status__c = 'Active'";
            }
            ...
            {
            filter = "FinServ__TotalRevenue__c > 50000000 AND "+query;
            }
            ...
            {
            filter = "LastActivityDate >= LAST_N_MONTHS:6 AND FinServ__TotalRevenue__c > 50000000 AND "+query;
            }
            ...
            {
            filter = "FinServ__TotalRevenue__c > 50000000 AND FinServ__Status__c = 'Active' AND "+query;
            }
            else if(whichOne==="bothsectionfilters123Selected")
            {
            filter = "LastActivityDate >= LAST_N_MONTHS:6 AND FinServ__TotalRevenue__c > 50000000 AND FinServ__Status__c = 'Active' AND "+query;
            }
            else if(whichOne==="all")
            {
            filter="all";   
            }
        //console.log("CombineFilters SAGAR " +filter);
